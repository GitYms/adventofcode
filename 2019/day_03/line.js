...
// const line2 = ['U7','R6','D4','L4']; // -> 6
// const line1 = ['R75','D30','R83','U83','L12','D49','R71','U7','L72'];
// const line2 = ['U62','R66','U55','R34','D71','R55','D58','R83'];  // -> 159
// const line1 = ['R98','U47','R26','D63','R33','U87','L62','D20','R33','U53','R51'];
// const line2 = ['U98','R91','D20','R16','D67','R40','U7','R15','U6','R7'];  // -> 135
function getPath(lines) {
  ...
  // 去掉路径上重复的点
  const set = new Set();
  result.forEach(e => set.add(JSON.stringify(e)))
  return [...set];
}
